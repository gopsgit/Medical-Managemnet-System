...
from .models import CompanyBank,Medicine,Employee,Customer,EmployeeSalary,MedicalDetails,Bill,EmployeeSalary,BillDetails,CustomerRequest,CompanyAccount,EmployeeBank,Customer
...
class MedicalDetailsSerializer(serializers.ModelSerializer):
	...
	def to_representation (self,instance):
		response = super().to_representation(instance)
		response['medicine'] = CompanySerializer(instance.medicine_id).data
		return response
...
class EmployeeSalarySerializer(serializers.ModelSerializer):
	...
	def to_representation (self,instance):
		response = super().to_representation(instance)
		response['employee'] = CompanySerializer(instance.employee_id).data
		return response
